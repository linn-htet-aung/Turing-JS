// 16 bits unicode character represented as String //
let str1 = "A";
console.log("A", str1.length);

// 32 bits unicode character (such as emoji) reprsented as String //
let str2 = "\ud83d\udc99";
console.log(str2, str2.length);

// String Literals //
// With single quote
let str3 = 'Hello World with Single Quote';

// With double quote
let str4 = "Hello World with Double Quote";
