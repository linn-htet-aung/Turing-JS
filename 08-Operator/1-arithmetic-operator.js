...
// Right hand   => Post Increment (increment operand but evaluate unincremented value of the operand)
// Let Hand    => Pre Increment (increment operand and evaluate value of the operand)
...
// ALGORITHM: If either one of the operands is string, execute string concat, otherwise number addition.
{
    let a = 1;
    let b = '2';
    let c = 0 / 0;
...
// ALGORITHM: If either one the opreands is object, convert object to primitive,
//              => Date Obj : toString();
